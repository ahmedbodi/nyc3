...
std::map<CTxDestination, std::vector<COutput>> CWallet::ListCoins() const
{
    ...
    // https://github.com/Nyc3Project/Nyc3coin/pull/10340, but that change has been
    // postponed until after https://github.com/Nyc3Project/Nyc3coin/pull/10244 to
                                ...
                                int& nChangePosInOut, std::string& strFailReason, const CCoinControl& coin_control, bool sign)
{
    ...
    unsigned int nBytes;
    {
        ...
        LOCK2(cs_main, cs_wallet);
        {
            ...
            // change transaction isn't always pay-to-nyc3-address
 ...
 * https://nyc3talk.org/?topic=54527, or
 * https://github.com/Nyc3Project/Nyc3coin/pull/1393.
 */
