 ...
 * between nyc3d, and nyc3-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Nyc3Project/Nyc3coin>";
    const std::string URL_WEBSITE = "<https://nyc3coin.org>";
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    GenerateNyc3s(fGenerate, gArgs.GetArg("-genproclimit", DEFAULT_GENERATE_THREADS), chainparams);
