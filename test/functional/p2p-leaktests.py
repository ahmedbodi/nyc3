...
Also test that nodes that send unsupported service bits to nyc3d are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if nyc3d ban behavior changes
    def on_open(self, conn):
        super().on_open(conn)
