...
# TestNode: A peer we use to send messages to nyc3d, and store responses.
...
class CompactBlocksTest(Nyc3TestFramework):
    ...
    # This test actually causes nyc3d to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nyc3d requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for nyc3d to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # nyc3d will not send blocktxn responses for blocks whose height is
