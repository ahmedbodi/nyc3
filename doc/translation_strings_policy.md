...
This document provides guidelines for internationalization of the Nyc3 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `nyc3_en.ts` remains unchanged.
