...
pkgdatadir = $(datadir)/nyc3
pkgincludedir = $(includedir)/nyc3
pkglibdir = $(libdir)/nyc3
pkglibexecdir = $(libexecdir)/nyc3
...
CONFIG_HEADER = $(top_builddir)/src/config/nyc3-config.h
CONFIG_CLEAN_FILES = libnyc3consensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	test/functional/test_runner.py test/util/nyc3-util-test.py
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/nyc3-config.h.in \
	$(top_srcdir)/test/config.ini.in \
	$(top_srcdir)/test/functional/test_runner.py \
	$(top_srcdir)/test/util/nyc3-util-test.py COPYING \
...
ACLOCAL = ${SHELL} /home/insightapi/nyc3/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /home/insightapi/nyc3/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/insightapi/nyc3/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/insightapi/nyc3/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
COPYRIGHT_HOLDERS_FINAL = The Nyc3 Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Nyc3 Core
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/insightapi/nyc3/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = nyc3
PACKAGE_BUGREPORT = https://github.com/Nyc3Project/Nyc3coin/issues
PACKAGE_NAME = Nyc3 Core
PACKAGE_STRING = Nyc3 Core 0.15.99
PACKAGE_TARNAME = nyc3
PACKAGE_URL = https://nyc3coin.org/
PACKAGE_VERSION = 0.15.99
PATH_SEPARATOR = :
PIC_FLAGS = -fPIC
PIE_FLAGS = -fPIE
PIGEON_CLI_NAME = nyc3-cli
PIGEON_DAEMON_NAME = nyc3d
PIGEON_GUI_NAME = nyc3-qt
PIGEON_TX_NAME = nyc3-tx
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/insightapi/nyc3
abs_srcdir = /home/insightapi/nyc3
abs_top_builddir = /home/insightapi/nyc3
abs_top_srcdir = /home/insightapi/nyc3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/insightapi/nyc3/build-aux/install-sh
...
pkgconfig_DATA = libnyc3consensus.pc
PIGEOND_BIN = $(top_builddir)/src/$(PIGEON_DAEMON_NAME)$(EXEEXT)
PIGEON_QT_BIN = $(top_builddir)/src/qt/$(PIGEON_GUI_NAME)$(EXEEXT)
PIGEON_CLI_BIN = $(top_builddir)/src/$(PIGEON_CLI_NAME)$(EXEEXT)
PIGEON_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = Nyc3-Qt.app
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/nyc3.ico \
...
COVERAGE_INFO = baseline.info \
  test_nyc3_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_nyc3_coverage.info test_nyc3.info
...
EXTRA_DIST = $(DIST_SHARE) test/functional/test_runner.py \
	...
	src/crypto/md_helper.c test/util/nyc3-util-test.py \
...
CLEANFILES = $(OSX_DMG) $(PIGEON_WIN_INSTALLER)
...
src/config/nyc3-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/nyc3-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/nyc3-config.h
$(top_srcdir)/src/config/nyc3-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/nyc3-config.h src/config/stamp-h1
libnyc3consensus.pc: $(top_builddir)/config.status $(srcdir)/libnyc3consensus.pc.in
...
$(PIGEON_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(PIGEOND_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(PIGEON_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(PIGEON_CLI_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/MacOS/Nyc3-Qt: $(PIGEON_QT_BIN)
	$(MKDIR_P) $(@D)
...
#test_nyc3.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_nyc3 -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_nyc3_filtered.info: test_nyc3.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_nyc3_filtered.info
...
#test_nyc3_coverage.info: baseline_filtered.info test_nyc3_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_nyc3_filtered.info -o $@

#total_coverage.info: test_nyc3_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_nyc3_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_nyc3.coverage/.dirstamp:  test_nyc3_coverage.info
...
#cov: test_nyc3.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_nyc3.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
